...
|:---:|:---------------------------:|:---------------------------------:|:------------------------:|
| DB1 |    Disease Related Data     |*confirmed_case.csv*<br>*death.csv*| <3208, 358><br><3208, 358> |
...
```
["county name", "2/28/2020",...,"2/17/2021"]
```
