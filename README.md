...
| DB5 |Vaccination Data: We collect the up-to-date state-based vaccination data from the Centers for Disease Control and Prevention, including how many doses of COVID-19 vaccines have been delivered, how many people have been vaccinated with those doses.|
