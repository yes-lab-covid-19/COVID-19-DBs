...
| DB5 |      Vaccination Data       |         *vaccination.csv*         |         <63, 51>       |
...
| DB5 |Vaccination Data: We collect the up-to-date state-based vaccination data from the Centers for Disease Control and Prevention, including how many doses of COVID-19 vaccines have been delivered, how many people have been vaccinated with those doses, etc.|
...
```
["State/Territory/Federal Entity", "Total Doses Delivered", "Doses Delivered per 100K", "18+ Doses Delivered per 100K",...,"Doses Delivered per 100k of 65+ pop"]
```
